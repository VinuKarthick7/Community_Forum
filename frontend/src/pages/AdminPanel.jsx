    ...
    return (
        <div style={styles.page}>
            ...
            {tab === 'categories' && (
                <div>
                    {/* Add form */}
                    <div style={styles.addBox} className="admin-add-box">
                        <h3 style={styles.boxTitle}>Add Category</h3>
                        {catError && <div className="alert alert-error">{catError}</div>}
                        <form onSubmit={handleAddCategory} style={styles.addForm} className="admin-add-form">
...
const styles = {
    page: { maxWidth: 960, margin: '0 auto', padding: 'clamp(1rem, 4vw, 2rem) clamp(0.5rem, 4vw, 1.5rem)' },
    ...
    addBox: { background: 'var(--bg-card)', border: '1px solid var(--border)', borderRadius: 'var(--radius-lg)', padding: 'clamp(1rem, 4vw, 1.5rem)', marginBottom: '1.5rem' },
